...
class SegmentsControllerTest < ActionController::TestCase
  ...
  test "should create segment" do
    assert_difference('Segment.count') do
      post :create, segment: { comment: @segment.comment, end: @segment.end, is_valid: @segment.is_valid, kcal: @segment.kcal, km: @segment.km, start: @segment.start, step: @segment.step, today: @segment.today }
    end
  ...
  test "should update segment" do
    patch :update, id: @segment, segment: { comment: @segment.comment, end: @segment.end, is_valid: @segment.is_valid, kcal: @segment.kcal, km: @segment.km, start: @segment.start, step: @segment.step, today: @segment.today }
    assert_redirected_to segment_path(assigns(:segment))
  end
